...
# 🚨 核心行为准则一：纯移动端（Android/iOS）战略与原生适配规范
...
# 🚨 核心行为准则四：软件架构设计解耦与防回归稳定性原则
**在开发、重构和集成任何新功能时，必须严格遵守“高内聚、低耦合”的模块化架构设计规范，从根本上杜绝“修改一处逻辑导致其他无关模块发生故障”的现象。以下是必须遵守的架构铁则：**
