...
const arrayBuffer = canvas.toBuffer('image/png');
...
function injectPngMetadata(pngBuffer, char) {
...
const out = injectPngMetadata(arrayBuffer);
fs.writeFileSync('test_canvas_out.png', Buffer.from(out));
console.log("Written test canvas PNG.");
