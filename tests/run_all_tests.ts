...
async function run() {
  ...
  const tests: { name: string; fn: () => Promise<void> | void }[] = [
    ...
    { name: "testChatStreamRetryOnDecodeError", fn: testChatStreamRetryOnDecodeError },
    { name: "testChatStreamNoRetryAfterPartialContent", fn: testChatStreamNoRetryAfterPartialContent },
    { name: "testChatStreamNoRetryOnNonTransientError", fn: testChatStreamNoRetryOnNonTransientError },
