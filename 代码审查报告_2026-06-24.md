...
| [promptBuilder.ts](file:///d:/projects/Mobile-Tavern/src/utils/promptBuilder.ts#L394-L396) | L394-396 | 硬编码 `deepseek` 模型名特判逻辑和 `[System Note: ...]` 推理引导 | 改为通用 `reasoningGuidance` 配置项，提示词移至预设包 |
