...
[![Version](https://img.shields.io/badge/version-1.7.10-blue.svg?style=for-the-badge)](https://github.com/zhengjie1399677/Mobile-Tavern)
...
* **原生返回退出**：Android 端第一次返回给出系统提示，2 秒内再次返回直接退出应用任务；处理位于原生 Activity，不依赖 WebView 路由状态。
