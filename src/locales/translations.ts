export const TRANSLATIONS: Record<string, Record<string, string>> = {
  "zh-CN": {
    ...
    "chat_import.title": "SillyTavern 历史对话导入",
    "chat_import.subtitle": "选择原版酒馆导出的 json 对话日志并合并入当前角色",
    "chat_import.upload_btn": "导入 JSON 对话历史",
  },
  "zh-TW": {
    "control_panel.title": "控制面板",
  ...
  "en": {
    ...
    "chat_import.subtitle": "Merge SillyTavern JSON logs into current character timeline",
    "chat_import.upload_btn": "Import ST JSON Chat History",
  },
  "ja": {
