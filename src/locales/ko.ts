...
export default {
  ...
  "host_sync.title": "호스트 동기화(덮어쓰기)",
  "host_sync.desc": "이 기기의 데이터를 PC 호스트로 통째로 올리거나, 호스트의 데이터를 통째로 가져옵니다. 병합이 아닌 덮어쓰기 동기화이며, 나중에 쓴 쪽이 적용됩니다.",
  ...
  "host_sync.overwrite_warning": "덮어쓰기 전에 확인을 받고 안전 스냅샷을 자동 저장합니다. 기기별 설정(API 키 포함)은 각 기기에 남으며 전송되지 않습니다.",
} as const;
