...
export default {
  ...
  "settings_hub.categories": "설정 카테고리",
  "settings_hub.back": "설정 카테고리로 돌아가기",
  ...
  "settings_hub.persona_title": "사용자 페르소나",
  "settings_hub.persona_desc": "프로필 및 페르소나 전환",
  "settings_hub.memory_title": "메모리 및 데이터",
  "settings_hub.memory_desc": "메모리 전략, 백업 및 데이터 관리",
  "settings_hub.composer_title": "Prompt 구성",
  ...
  "settings_hub.about_category_desc": "버전, 업데이트 및 시스템 보고서",
  "settings_hub.about_product_desc": "모바일용 경량 롤플레잉 프런트엔드",
  "settings_hub.open": "열기",
  ...
  "report.copy_section": "섹션 복사",
  "report.copy_errors": "오류만 복사",
  "report.copied_section": "섹션이 클립보드에 복사되었습니다.",
  "report.copied_errors": "오류 섹션 {count}개가 복사되었습니다.",
  "report.no_errors": "진단에서 오류나 경고가 발견되지 않았습니다.",
  ...
  "local_resources.description": "리소스는 기기에 별도로 저장됩니다. 이미지는 복사한 CSS 변수로 사용할 수 있고 오디오와 비디오는 미리 볼 수 있습니다.",
  "local_resources.import": "가져오기",
  "local_resources.empty": "가져온 이미지, 비디오 또는 음악이 없습니다.",
  "local_resources.load_failed": "리소스 로드 실패",
  "local_resources.import_failed": "리소스 가져오기 실패",
  "local_resources.preview_failed": "미리보기 실패",
  "local_resources.preview": "리소스 미리보기",
  "local_resources.copy_reference": "리소스 참조 복사",
  "local_resources.copy_css_reference": "이미지 CSS 변수 복사",
  "local_resources.delete": "리소스 삭제",
  "local_resources.copy_success": "복사됨: {reference}",
  "local_resources.copy_success_title": "복사 완료",
  "local_resources.copy_failed": "복사 실패",
  "local_resources.delete_confirm": "로컬 리소스 '{name}'을(를) 삭제할까요? 이를 참조하는 테마에서는 더 이상 표시되지 않습니다.",
  ...
  "theme.ui_density": "인터페이스 밀도",
  "theme.ui_density_compact": "컴팩트(기본)",
  "theme.ui_density_accessible": "읽기 편하게",
  "theme.ui_density_desc": "컴팩트는 일반 사용자용입니다. 읽기 편하게 모드는 보조 작은 글자만 확대하며 터치와 스크린 리더 지원은 항상 유지됩니다.",
  ...
  "community.preparing_title": "커뮤니티 입구가 준비되었습니다",
  "community.preparing_description": "서버 기능은 단계적으로 연결됩니다. 클라우드가 오프라인이어도 로컬 카드와 대화에는 영향을 주지 않습니다.",
  "community.planned_features": "예정된 커뮤니티 기능",
  "community.upload": "업로드",
  "community.download": "다운로드",
  "community.forum": "포럼",
  "community.character_missing": "먼저 로컬 캐릭터 카드를 선택하세요",
  "community.upload_success": "캐릭터 카드를 업로드했습니다",
  "community.upload_failed": "업로드에 실패했습니다. 다시 시도해 주세요. 원인: {error}",
  "community.download_success": "캐릭터 카드를 로컬에 저장했습니다",
  "community.download_failed": "다운로드에 실패했습니다. 다시 시도해 주세요. 원인: {error}",
  "community.share_title": "캐릭터 카드 공유",
  "community.select_character": "로컬 캐릭터 카드 선택",
  "community.identity_hint": "공유와 다운로드에 이 이름이 표시되며, 이 기기의 UUID로 기여가 기록됩니다.",
  "community.search_placeholder": "캐릭터 카드 검색",
  "community.refresh": "새로고침",
  "community.load_failed": "커뮤니티 콘텐츠를 불러오지 못했습니다: {error}",
  "community.empty": "표시할 캐릭터 카드가 아직 없습니다",
  ...
  "api.reasoning_strength_title": "추론 강도 (Reasoning Effort)",
  "api.reasoning_strength_desc": "통합 강도는 모델 능력에 따라 제공자 파라미터(reasoning_effort / thinking / enable_thinking)로 변환됩니다. 자동은 아무것도 주입하지 않으며 미인식 모델에서는 그대로 유지됩니다.",
  "api.reasoning_strength.auto": "자동",
  "api.reasoning_strength.off": "끄기",
  "api.reasoning_strength.low": "낮음",
  "api.reasoning_strength.medium": "중간",
  "api.reasoning_strength.high": "높음",
  "api.reasoning_strength.max": "최대",
  "api.reasoning_strength_unavailable": "현재 모델/엔드포인트에서는 추론 제어를 인식할 수 없어 자동(파라미터 미주입)만 사용할 수 있습니다.",
  "api.reasoning_strength_clamped": "이 강도는 현재 모델에서 가장 가까운 지원 단계로 조정됩니다.",
  ...
  "persona.modal_title": "플레이어 설정 관리",
  "persona.modal_subtitle": "대화에서 표시되는 신원을 전환하거나 관리합니다",
  "persona.modal_create_title": "새 플레이어 설정",
  "persona.modal_edit_title": "플레이어 설정 편집",
  "persona.modal_edit_subtitle": "이름과 배경 설정",
  "persona.avatar_label": "아바타",
  "persona.upload_avatar": "아바타 업로드",
  "persona.remove_avatar": "제거",
  "persona.name_label": "설정 이름",
  "persona.name_placeholder_new": "예: 여행자, 지휘관, 탐정...",
  "persona.desc_label": "설정 메모 및 설명 (Persona Description)",
  "persona.desc_placeholder_new": "세계관에서의 배경, 성격, 말투 등을 설명하세요. 플레이어 정보로 AI 프롬프트에 주입됩니다...",
  "persona.desc_hint": "대화 중 AI 모델에게 당신의 배경을 알려 몰입감을 높입니다.",
  "persona.save_apply": "저장 및 적용",
  "persona.existing_count": "기존 설정 ({count})",
  "persona.create_new": "새 설정",
  "persona.active_badge": "사용 중",
  "persona.use": "사용",
  "persona.edit_action": "설정 편집",
  "persona.delete_action": "설정 삭제",
  "persona.no_description": "상세 설명이 아직 없습니다",
  "persona.avatar_too_large": "이미지 파일은 5MB를 초과할 수 없습니다!",
  "persona.avatar_failed": "이미지 처리 실패: ",
  "persona.click_to_configure": "탭하여 자세한 설정 메모 구성",
  "persona.switch_mid_chat_warning": "이 대화에는 이미 메시지가 있습니다. 대화 중 플레이어 설정을 전환하면 모델이 플레이어의 신원, 말투, 맥락을 혼동할 수 있습니다. 계속할까요?",
  "persona.at_least_one": "플레이어 설정은 최소 1개 이상 유지해야 합니다!",
  "persona.delete_confirm": "설정 \"{name}\"을(를) 삭제할까요?",
  "persona.name_required": "설정 이름을 입력하세요!",
  "chat_header.all_branches": "모든 분기 ({count}) ›",
  "chat_header.new_branch": "새 대화 분기",
  "chat_header.persona_section": "플레이어 설정",
  "chat_header.persona_manage": "관리 및 전환 ›",
  "session_manager.branch_title": "분기 관리",
  "session_manager.branch_count_hint": "총 {count}개 대화 분기 · 평행 우주",
  "session_manager.tab_universe": "평행 우주 지도",
  "session_manager.tab_sessions": "분기 목록",
  "session_manager.new_branch_chat": "새 분기 (새 대화)",
  ...
  "memory_sys.recall_timeout": "리콜 타임아웃 보호",
  "memory_sys.recall_timeout_desc": "3초 초과 시 리콜 건너뛰기 (첫 토큰 응답 우선)",
  ...
  "history.title": "세션 관리자",
  "history.sort_by_time": "최근 세션",
  "history.sort_by_char": "캐릭터별",
  "history.search_placeholder": "세션, 캐릭터 또는 메시지 검색",
  "history.clear_search": "검색 지우기",
  "history.search_empty": "일치하는 세션이 없습니다",
  "history.view_label": "세션 정렬 방식",
  "history.active": "현재",
  "history.more_actions": "더보기",
  "history.rename": "이름 변경",
  "history.rename_prompt": "새 세션 이름 입력",
  ...
  "history.loaded_sessions": "대화 {total}개 중 {loaded}개 불러옴",
  "history.load_more": "이전 대화 불러오기",
  "history.loading_more": "불러오는 중…",
  ...
  "scanner.permission_title": "모든 파일 접근 권한 필요",
  "scanner.permission_desc": "권한을 부여하면 일반 앱의 공유 미디어 폴더를 포함해 접근 가능한 공유 및 외장 저장소에서 PNG/JSON 카드를 검색합니다. 시스템이 격리한 비공개 폴더는 읽을 수 없으며, 거부하거나 돌아오면 검색하지 않습니다.",
  "scanner.permission_btn": "설정 열기 및 스캔",
  ...
  "quick_dialogue.confirm_summarize": "이 세션에서 아직 정리되지 않은 대화를 요약할까요? 이야기 타임라인이 업데이트되며 원본 메시지는 삭제되지 않습니다.",
  "quick_dialogue.summarize": "대화 기억 정리",
  ...
  "chat_input.placeholder_default": "메시지 보내기…",
  ...
  "chat_header.session_center": "대화 도구",
  "chat_header.session": "대화",
  "chat_header.new_conversation": "새 대화",
  "chat_header.recent_sessions": "최근 대화",
  ...
  "session_manager.tab_list": "세션",
  "session_manager.tab_diagram": "평행 우주",
  "session_manager.empty_tree": "아직 브랜치 계보가 없습니다. 브랜치를 만들거나 되돌리면 여기에 표시됩니다.",
  "memory.audit_title": "장기 기억 감사",
  "memory.turn_label": "{turn}턴에 연결됨",
  "memory.fragment_number": "기억 {number}",
  "memory.new_fragment": "새 기억",
  "memory.content_label": "사건 사실",
  "memory.content_placeholder": "장기간 보존할 간결한 사실을 입력하세요",
  "memory.tags_label": "관련 태그",
  "memory.remove_tag": "태그 {tag} 제거",
  "memory.no_tags": "관련 태그 없음",
  "memory.tag_placeholder": "태그 입력 후 Enter",
  "memory.add_tag": "태그 추가",
  "memory.inspect_turn": "{turn}턴 기억 감사",
  "memory.save_failed": "기억을 저장하지 못했습니다. 다시 시도하세요.",
  "memory.delete_failed": "기억을 무효화하지 못했습니다. 다시 시도하세요.",
  "common.delete": "삭제",
  "common.save": "저장",
  "common.close": "닫기",
  "common.saving": "저장 중…",
  ...
  "prompt_composer.title": "Prompt 구성",
  "prompt_composer.description": "메시지 역할, 데이터 소스, 순서와 기록 위치를 모두 직접 정합니다.",
  "prompt_composer.independent_notice": "Prompt 구성이 활성화되었습니다. 메시지 구조와 순서는 별도의 Prompt 구성 카테고리에서 관리하세요.",
  "prompt_composer.enable": "Prompt 구성 활성화",
  ...
  "prompt_composer.scene_profiles": "세션 장면 프로필",
  "prompt_composer.scene_session_scope": "현재 세션에만 적용",
  "prompt_composer.scene_requires_session": "먼저 세션을 여세요",
  "prompt_composer.scene_base": "기본 구성",
  "prompt_composer.scene_create": "장면 저장",
  "prompt_composer.scene_name_prompt": "장면 프로필 이름을 입력하세요. 현재 Prompt 블록 상태를 저장합니다.",
  "prompt_composer.scene_overwrite": "현재 상태로 덮어쓰기",
  "prompt_composer.scene_delete": "장면 삭제",
  "prompt_composer.scene_delete_confirm": "장면 프로필 ‘{name}’을 삭제할까요?",
  "prompt_composer.scene_save_failed": "장면 프로필을 세션에 저장하지 못했습니다. 다시 시도하세요.",
  ...
  "prompt_composer.group_placement": "위치별 그룹",
  "prompt_composer.sort_order": "구성 순서",
  "prompt_composer.sort_tokens": "Token 비용순",
  "prompt_composer.list_stats": "{visible}/{total}개 표시 · 약 {tokens} Token",
  "prompt_composer.selected_count": "{count}개 선택",
  "prompt_composer.select_visible": "표시 항목 선택",
  "prompt_composer.clear_selection": "선택 해제",
  "prompt_composer.batch_enable": "일괄 활성화",
  "prompt_composer.batch_disable": "일괄 비활성화",
  "prompt_composer.batch_delete": "일괄 삭제",
  "prompt_composer.batch_delete_confirm": "선택한 Prompt 블록 {count}개를 삭제할까요? 대응하는 프롬프트 모듈도 함께 삭제됩니다.",
  "prompt_composer.list_empty": "검색 조건에 맞는 Prompt가 없습니다.",
  "prompt_composer.select_block": "블록 선택: {name}",
  "prompt_composer.unselect_block": "블록 선택 해제: {name}",
  ...
  "prompt_composer.group_label_history": "채팅 기록",
  "prompt_composer.group_label_template": "템플릿",
  "prompt_composer.group_label_ordered": "순서 배치",
  "prompt_composer.group_label_in_chat": "기록 내 주입",
  ...
  "prompt_composer.confirm_delete": "이 Prompt 블록을 삭제하시겠습니까? 대응하는 프롬프트 모듈도 함께 삭제됩니다.",
  ...
  "prompt_composer.free_mode": "Prompt 구성",
  ...
  "prompt_composer.advanced_toggle": "고급",
  "prompt_composer.advanced_tools_title": "템플릿 및 고급 도구",
  "prompt_composer.st_compat_badge": "ST 호환 {count}개",
  "prompt_composer.tutorial_core_title": "핵심 메커니즘 및 가이드",
  "prompt_composer.tutorial_macros_title": "자주 사용하는 동적 태그(매크로) 목록",
  "prompt_composer.macro_char_desc": "현재 캐릭터 이름",
  "prompt_composer.macro_user_desc": "현재 사용자 이름 / 호칭",
  "prompt_composer.macro_description_desc": "캐릭터 상세 설명",
  "prompt_composer.macro_personality_desc": "캐릭터 성격 특성",
  ...
  "prompt_composer.advanced_go_composer": "조건 및 Token 정책 등 고급 편집은 Prompt 구성에서 수행하세요.",
  "prompt_composer.open_composer": "Prompt 구성 열기",
  ...
  "lore_editor.label_secondary_keys": "보조 키워드 (Secondary Keys)",
  "lore_editor.placeholder_secondary_keys": "선택 사항, 쉼표로 구분",
  "lore_editor.label_selective_logic": "보조 키워드 매칭 로직",
  "lore_editor.logic_and_any": "주 키워드 및 보조 중 하나 (AND ANY)",
  "lore_editor.logic_and_all": "주 키워드 및 모든 보조 (AND ALL)",
  "lore_editor.logic_not_any": "주 키워드 포함 및 보조 제외 (NOT ANY)",
  "lore_editor.logic_not_all": "주 키워드 포함 및 모든 보조 동시 제외 (NOT ALL)",
  "lore_editor.label_sticky": "지속 라운드 수 (Sticky)",
  "lore_editor.label_cooldown": "쿨다운 라운드 수 (Cooldown)",
  "lore_editor.label_delay": "지연 라운드 수 (Delay)",
  "lore_editor.checkbox_exclude_recursion": "재귀 검색에서 제외",
  "lore_editor.checkbox_prevent_recursion": "내용에서 재귀 유발 방지",
  "lore_editor.timed_recursion_title": "시효 제어 및 재귀 검색 (고급)",
  ...
  "prompt_composer.template_group_scenes": "장면 프리셋",
  "prompt_composer.scene_lightweight_chat": "가벼운 대화",
  "prompt_composer.scene_lightweight_chat_description": "작은 컨텍스트로 핵심 캐릭터 데이터와 최근 대화를 유지합니다.",
  "prompt_composer.scene_long_chat_budget": "긴 대화 Token 절약",
  "prompt_composer.scene_long_chat_budget_description": "최근 기록을 우선하고 명시된 우선순위에 따라 데이터 블록을 줄입니다.",
  "prompt_composer.scene_worldbook_priority": "월드북 우선",
  "prompt_composer.scene_worldbook_priority_description": "캐릭터 정의 전후에 활성화된 월드북 데이터를 유지합니다.",
  "prompt_composer.scene_memory_enhanced": "장기 기억 강화",
  "prompt_composer.scene_memory_enhanced_description": "요약, 회상 기억, 표 기억을 분리해 개별 정렬과 축소를 지원합니다.",
  "prompt_composer.scene_character_card_compatible": "캐릭터 카드 호환",
  "prompt_composer.scene_character_card_compatible_description": "캐릭터 데이터, 예시 대화, 기록, 기록 이후 Prompt를 배치합니다.",
  ...
  "settings_hub.host_title": "호스트 및 연결",
  "settings_hub.host_desc": "이 기기에서 기능을 제공하거나 같은 네트워크의 호스트에 연결합니다",
  "host_binding.host_role_title": "이 기기를 호스트로 사용",
  "host_binding.host_role_desc": "이 기기에서 헤드리스 호스트 프로세스를 실행해 같은 네트워크의 다른 기기가 접속해 호출할 수 있게 합니다.",
  "host_binding.bind_host": "바인드 주소",
  "host_binding.bind_host_hint": "127.0.0.1은 이 기기에서만 접근할 수 있습니다. 같은 네트워크에서 쓰려면 이 기기의 LAN 주소나 0.0.0.0을 지정하세요.",
  "host_binding.bind_host_loopback": "로컬 전용",
  "host_binding.bind_host_all": "외부 공개",
  "host_binding.bind_port": "바인드 포트",
  "host_binding.port_invalid": "포트는 1~65535 사이의 정수여야 합니다",
  "host_binding.access_key": "접근 키",
  "host_binding.access_key_hint": "로컬 외부로 바인드할 때 필수입니다. 없으면 호스트 프로세스가 시작을 거부합니다.",
  "host_binding.access_key_generate": "생성",
  "host_binding.access_key_copy": "접근 키 복사",
  "host_binding.access_key_copied": "접근 키를 클립보드에 복사했습니다",
  "host_binding.access_key_unsupported": "이 실행 환경에는 안전한 난수 원본이 없습니다. 충분히 긴 무작위 문자열을 직접 입력하세요.",
  "host_binding.cors_origins": "브라우저 CORS 허용 목록",
  "host_binding.cors_origins_hint": "쉼표로 구분합니다. 비워 두면 어떤 교차 출처도 허용하지 않습니다. 네이티브 클라이언트와 CLI에는 영향이 없습니다.",
  "host_binding.cors_placeholder": "http://192.168.1.20:5173",
  "host_binding.env_title": "시작 설정",
  "host_binding.env_desc": "아래 줄을 호스트 머신의 프로젝트 루트 .env에 기록한 뒤 npm run headless를 실행하세요. 환경 변수는 앱 내 설정보다 우선합니다.",
  "host_binding.env_copy": "시작 설정 복사",
  "host_binding.env_copied": "시작 설정을 복사했습니다",
  "host_binding.copy_failed": "복사에 실패했습니다. 텍스트를 선택해 직접 복사하세요.",
  "host_binding.assessment_ok": "이 설정으로 호스트 프로세스를 시작할 수 있습니다",
  "host_binding.assessment_warning": "시작은 되지만 알아 두어야 할 위험이 있습니다",
  "host_binding.assessment_error": "이 설정으로는 호스트 프로세스가 시작을 거부합니다",
  "host_binding.issue_host_required": "바인드 주소를 입력하세요",
  "host_binding.issue_port_invalid": "포트 {detail}이(가) 올바르지 않습니다",
  "host_binding.issue_non_loopback_without_key": "{detail}에 바인드하면서 접근 키가 없습니다. 호스트 프로세스가 시작을 거부합니다",
  "host_binding.issue_weak_access_key": "접근 키가 {detail}자뿐입니다. ‘생성’으로 강한 키를 만드세요",
  "host_binding.issue_all_interfaces_exposed": "0.0.0.0은 핫스팟과 인터넷에서 도달 가능한 어댑터까지 노출합니다. 특정 LAN 주소를 권장합니다",
  "host_binding.issue_lan_exposed_cleartext": "같은 네트워크에서 평문 HTTP로 전송됩니다. 신뢰할 수 있는 네트워크에서만 사용하세요",
  "host_binding.issue_wildcard_cors": "와일드카드 CORS 출처는 모든 웹 페이지가 자격 증명을 보내도록 허용하므로 서버 측 강화에서 거부됩니다",
  "host_binding.lan_confirm_title": "LAN 공개 확인",
  "host_binding.lan_confirm_message": "{host}에 바인드하면 같은 네트워크의 모든 기기가 이 호스트에 접근할 수 있습니다. 접근 키가 설정되어 있는지, 신뢰할 수 있는 네트워크에서만 쓰는지 확인하세요.",
  "host_binding.lan_blocked_title": "이 설정으로는 호스트를 시작할 수 없습니다",
  "host_binding.lan_blocked_message": "먼저 위 오류를 고치고(보통 접근 키 누락이나 잘못된 포트) 시작 설정을 생성하세요.",
  "host_binding.remote_role_title": "원격 호스트에 연결",
  "host_binding.remote_role_desc": "호스트 주소를 입력해 연결 상태를 확인합니다.",
  "host_binding.remote_url": "호스트 주소",
  "host_binding.remote_url_placeholder": "192.168.1.10:18080",
  "host_binding.remote_access_key": "호스트 접근 키",
  "host_binding.remote_test": "연결 테스트",
  "host_binding.remote_testing": "연결 중",
  "host_binding.remote_ok": "연결됨 · {ms} ms",
  "host_binding.remote_summary": "캐릭터 {characters} · 세션 {sessions} · 실행 모드 {mode}",
  "host_binding.remote_fail_invalid_url": "주소 형식을 인식할 수 없습니다. 호스트 이름이나 IP를 입력하세요(포트 선택).",
  "host_binding.remote_fail_unauthorized": "호스트가 접근 키를 거부했습니다. 호스트 쪽과 일치하는지 확인하세요.",
  "host_binding.remote_fail_unreachable": "해당 주소에 연결할 수 없습니다. 호스트 실행 여부, 포트 개방, 같은 네트워크인지 확인하세요.",
  "host_binding.remote_fail_not_a_host": "응답은 있지만 Mobile Tavern 호스트가 아닙니다.",
  "host_binding.stage0_notice": "지금은 연결 확인만 제공합니다. 데이터 동기화와 원격 세션은 아직 열려 있지 않아 원격 모드는 일상적인 사용 형태가 아닙니다.",
  "host_binding.access_key_placeholder": "미설정(외부 공개 시 필수)",
  "host_sync.title": "호스트 동기화",
  "host_sync.desc": "PC 호스트와 양방향으로 데이터를 동기화합니다. 기본값인 '병합'은 양쪽 내용의 합집합을 취하므로 한쪽에만 있는 세션과 캐릭터도 유지되고 삭제도 기기 간에 전파됩니다. '덮어쓰기'는 나중에 쓴 쪽이 적용되며 다른 쪽에만 있는 데이터를 지웁니다.",
  "host_sync.target_label": "원격 호스트",
  "host_sync.not_configured": "호스트 주소 미설정",
  "host_sync.go_to_settings": "「호스트 및 연결」에서 설정",
  "host_sync.mode_label": "동기화 방식",
  "host_sync.mode_merge": "병합(권장)",
  "host_sync.mode_replace": "덮어쓰기",
  "host_sync.mode_merge_hint": "양쪽의 합집합입니다. 한쪽에만 있는 세션·캐릭터·기억도 유지되고, 다른 기기에서 삭제한 내용도 함께 넘어옵니다. 일상적인 동기화에 사용하세요.",
  "host_sync.mode_replace_hint": "나중에 쓴 쪽이 적용됩니다. 다른 기기에만 있는 데이터는 이 기기의 내용으로 통째로 바뀝니다. 한쪽을 기준으로 삼을 때만 사용하세요.",
  "host_sync.push_btn": "호스트로 보내기",
  "host_sync.pull_btn": "호스트에서 가져오기",
  "host_sync.pushing": "보내는 중...",
  "host_sync.pulling": "가져오는 중...",
  "host_sync.merge_warning": "동기화 전에 안전 스냅샷을 저장합니다. 기기별 설정(API 키 포함)은 각 기기에 남으며 전송되지 않습니다.",
  "host_sync.overwrite_warning": "덮어쓰기는 다른 기기에만 있는 데이터를 지우므로 매번 확인을 받고 안전 스냅샷을 자동 저장합니다.",
  "host_sync.advanced_label": "고급 옵션",
