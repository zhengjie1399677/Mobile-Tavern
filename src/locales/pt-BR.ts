...
export default {
  ...
  "host_sync.title": "Sincronização com host (sobrescrita)",
  "host_sync.desc": "Envia os dados deste dispositivo para o host no PC ou traz os dados do host de volta. É sobrescrita, não mesclagem: quem escreve por último vence.",
  ...
  "host_sync.overwrite_warning": "Cada sobrescrita pede confirmação e salva antes um snapshot de segurança. As configurações locais (incluindo chaves de API) ficam no próprio dispositivo e não são transferidas.",
} as const;
