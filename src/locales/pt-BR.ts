...
export default {
  ...
  "settings_hub.categories": "Categorias de configurações",
  "settings_hub.back": "Voltar às categorias",
  "settings_hub.home_desc": "Escolha uma categoria para ver apenas as configurações necessárias.",
  "settings_hub.connection_title": "Modelos e conexão",
  "settings_hub.connection_desc": "API, modelos, predefinições e parâmetros de geração",
  "settings_hub.prompt_title": "Predefinições",
  "settings_hub.prompt_desc": "Prompts principais, módulos e scripts regex",
  "settings_hub.appearance_title": "Aparência e exibição",
  "settings_hub.appearance_desc": "Temas, tipografia e fundos de chat",
  "settings_hub.persona_title": "Persona do usuário",
  "settings_hub.persona_desc": "Perfis de identidade e troca de persona",
  "settings_hub.memory_title": "Memória e dados",
  "settings_hub.memory_desc": "Estratégia de memória, backups e gestão de dados",
  "settings_hub.composer_title": "Compositor Prompt livre",
  ...
  "settings_hub.about_category_desc": "Versão, atualizações e relatório do sistema",
  "settings_hub.about_product_desc": "Um cliente leve de interpretação para dispositivos móveis",
  ...
  "plugin_manager.builtin": "Incluído",
  ...
  "report.copy_section": "Copiar seção",
  "report.copy_errors": "Copiar apenas erros",
  "report.copied_section": "Seção copiada para a área de transferência.",
  "report.copied_errors": "{count} seção(ões) com erro copiada(s).",
  "report.no_errors": "Nenhum erro ou aviso encontrado no diagnóstico.",
  ...
  "local_resources.description": "Os recursos ficam neste dispositivo. Imagens usam variáveis CSS copiadas; áudio e vídeo podem ser visualizados.",
  "local_resources.import": "Importar",
  "local_resources.empty": "Ainda não há imagens, vídeos ou músicas locais.",
  "local_resources.load_failed": "Falha ao carregar recursos",
  "local_resources.import_failed": "Falha ao importar recursos",
  "local_resources.preview_failed": "Falha na visualização",
  "local_resources.preview": "Visualizar recurso",
  "local_resources.copy_reference": "Copiar referência do recurso",
  "local_resources.copy_css_reference": "Copiar variável CSS da imagem",
  "local_resources.delete": "Excluir recurso",
  "local_resources.copy_success": "Copiado: {reference}",
  "local_resources.copy_success_title": "Copiado",
  "local_resources.copy_failed": "Falha ao copiar",
  "local_resources.delete_confirm": "Excluir o recurso local “{name}”? Temas que o usam deixarão de exibi-lo.",
  ...
  "theme.ui_density": "Densidade da interface",
  "theme.ui_density_compact": "Compacta (padrão)",
  "theme.ui_density_accessible": "Leitura fácil",
  "theme.ui_density_desc": "Compacta é a visualização normal. Leitura fácil amplia apenas textos secundários pequenos; toque e leitores de tela continuam disponíveis nos dois modos.",
  ...
  "nav.chat-history": "Sessões",
  "nav.workbench": "Área de Trabalho",
  "nav.global-worldbook": "Mundolivro",
  "nav.settings": "Config.",
  "community.title": "Comunidade de personagens",
  "community.subtitle": "Descubra, compartilhe e baixe cartões de personagens",
  "community.preparing_title": "A entrada da comunidade está pronta",
  "community.preparing_description": "Os recursos do servidor serão conectados gradualmente. Cartões e conversas locais continuam disponíveis sem a nuvem.",
  "community.planned_features": "Recursos planejados da comunidade",
  "community.upload": "Enviar",
  "community.download": "Baixar",
  "community.forum": "Fórum",
  "community.character_missing": "Selecione primeiro um cartão de personagem local",
  "community.upload_success": "Cartão de personagem enviado",
  "community.upload_failed": "Falha no envio. Tente novamente. Motivo: {error}",
  "community.download_success": "Cartão de personagem salvo localmente",
  "community.download_failed": "Falha no download. Tente novamente. Motivo: {error}",
  "community.share_title": "Compartilhar um cartão de personagem",
  "community.select_character": "Selecionar um cartão local",
  "community.identity_hint": "Compartilhamentos e downloads usam este nome, e a contribuição é registrada pelo UUID do dispositivo.",
  "community.search_placeholder": "Pesquisar cartões de personagens",
  "community.refresh": "Atualizar",
  "community.load_failed": "Não foi possível carregar o conteúdo da comunidade: {error}",
  "community.empty": "Ainda não há cartões de personagens",
  ...
  "api.reasoning_strength_title": "Intensidade de raciocínio (Reasoning Effort)",
  "api.reasoning_strength_desc": "O nível unificado é convertido, conforme a capacidade do modelo, em parâmetros do provedor (reasoning_effort / thinking / enable_thinking). Automático não injeta nada e permanece em modelos não reconhecidos.",
  "api.reasoning_strength.auto": "Automático",
  "api.reasoning_strength.off": "Desativado",
  "api.reasoning_strength.low": "Baixo",
  "api.reasoning_strength.medium": "Médio",
  "api.reasoning_strength.high": "Alto",
  "api.reasoning_strength.max": "Máximo",
  "api.reasoning_strength_unavailable": "O modelo ou endpoint atual não possui controle de raciocínio reconhecido; apenas Automático (sem injeção de parâmetros) está disponível.",
  "api.reasoning_strength_clamped": "Este nível é ajustado para o nível compatível mais próximo do modelo atual.",
  ...
  "persona.modal_title": "Gerenciar Persona do Jogador",
  "persona.modal_subtitle": "Alterne ou gerencie a identidade exibida nos chats",
  "persona.modal_create_title": "Nova Persona do Jogador",
  "persona.modal_edit_title": "Editar Persona do Jogador",
  "persona.modal_edit_subtitle": "Defina seu nome e histórico",
  "persona.avatar_label": "Avatar",
  "persona.upload_avatar": "Enviar avatar",
  "persona.remove_avatar": "Remover",
  "persona.name_label": "Nome da persona",
  "persona.name_placeholder_new": "Ex.: Viajante, Comandante, Detetive...",
  "persona.desc_label": "Notas e descrição da persona (Persona Description)",
  "persona.desc_placeholder_new": "Descreva seu histórico, personalidade e tom de fala. Isso será injetado no prompt de IA como informações do jogador...",
  "persona.desc_hint": "Isso informa ao modelo de IA seu histórico durante as conversas para mais imersão.",
  "persona.save_apply": "Salvar e aplicar",
  "persona.existing_count": "Personas existentes ({count})",
  "persona.create_new": "Nova persona",
  "persona.active_badge": "Em uso",
  "persona.use": "Usar",
  "persona.edit_action": "Editar persona",
  "persona.delete_action": "Excluir persona",
  "persona.no_description": "Sem descrição detalhada ainda",
  "persona.avatar_too_large": "O arquivo de imagem não pode exceder 5 MB!",
  "persona.avatar_failed": "Falha ao processar imagem: ",
  "persona.click_to_configure": "Toque para configurar notas detalhadas",
  "persona.switch_mid_chat_warning": "Esta conversa já possui mensagens. Trocar a persona do jogador no meio do chat pode confundir o modelo sobre identidade, tom e contexto. Continuar?",
  "persona.at_least_one": "É necessário manter pelo menos uma persona do jogador!",
  "persona.delete_confirm": "Excluir a persona \"{name}\"?",
  "persona.name_required": "Informe o nome da persona!",
  "chat_header.all_branches": "Todos os ramos ({count}) ›",
  "chat_header.new_branch": "Novo ramo de conversa",
  "chat_header.persona_section": "Persona do jogador",
  "chat_header.persona_manage": "Gerenciar e alternar ›",
  "session_manager.branch_title": "Gerenciamento de ramos",
  "session_manager.branch_count_hint": "{count} ramos de conversa · Universos paralelos",
  "session_manager.tab_universe": "Mapa do Universo",
  "session_manager.tab_sessions": "Lista de ramos",
  "session_manager.new_branch_chat": "Novo ramo (Nova conversa)",
  ...
  "memory_sys.recall_timeout": "Proteção de tempo limite de recall",
  "memory_sys.recall_timeout_desc": "Pular recall após 3s para manter primeira resposta rápida",
  ...
  "history.title": "Gerenciador de sessões",
  "history.sort_by_time": "Recentes",
  "history.sort_by_char": "Por Personagem",
  "history.search_placeholder": "Buscar sessões, personagens ou mensagens",
  "history.clear_search": "Limpar busca",
  "history.search_empty": "Nenhuma sessão correspondente",
  "history.view_label": "Organização das sessões",
  "history.active": "Atual",
  "history.more_actions": "Mais ações",
  "history.rename": "Renomear",
  "history.rename_prompt": "Digite um novo nome para a sessão",
  ...
  "history.loaded_sessions": "{loaded} de {total} conversas carregadas",
  "history.load_more": "Carregar conversas anteriores",
  "history.loading_more": "Carregando…",
  ...
  "scanner.permission_title": "Acesso a Todos os Arquivos Necessário",
  "scanner.permission_desc": "Após autorizar, cartas PNG/JSON são buscadas no armazenamento compartilhado e removível acessível, incluindo pastas de mídia compartilhada de outros apps. Pastas privadas isoladas pelo sistema permanecem inacessíveis. Negar ou voltar não inicia a busca.",
  "scanner.permission_btn": "Abrir Configurações e Buscar",
  ...
  "scanner.sort_by_time": "Data",
  "scanner.sort_by_size": "Tamanho",
  "scanner.sort_by_name": "Nome",
  ...
  "quick_dialogue.confirm_summarize": "Resumir a conversa ainda não organizada desta sessão? A linha do tempo será atualizada e as mensagens originais não serão removidas.",
  "quick_dialogue.summarize": "Atualizar memória",
  ...
  "message_bubble.click_to_save": "Clique para salvar imagem",
  ...
  "chat_input.placeholder_default": "Enviar mensagem…",
  ...
  "chat_header.session_center": "Ferramentas da conversa",
  "chat_header.session": "Conversa",
  "chat_header.new_conversation": "Nova conversa",
  "chat_header.recent_sessions": "Conversas recentes",
  ...
  "characters_tab.layout_group": "Layout dos cartões de personagem",
  "characters_tab.layout_list": "Layout em lista",
  "characters_tab.layout_shelf": "Layout em estante",
  "characters_tab.layout_showcase": "Cartões grandes em duas colunas",
  "session_manager.title": "Gerenciador de sessões",
  ...
  "session_manager.tab_list": "Sessões",
  "session_manager.tab_diagram": "Universo paralelo",
  "session_manager.empty_tree": "Ainda não há linhagem de ramificações. Crie ou retorne a uma ramificação para vê-la aqui.",
  "memory.audit_title": "Auditoria de memória de longo prazo",
  "memory.turn_label": "Vinculada ao turno {turn}",
  "memory.fragment_number": "Memória {number}",
  "memory.new_fragment": "Nova memória",
  "memory.content_label": "Fato do evento",
  "memory.content_placeholder": "Digite um fato conciso para manter a longo prazo",
  "memory.tags_label": "Tags relacionadas",
  "memory.remove_tag": "Remover tag {tag}",
  "memory.no_tags": "Nenhuma tag relacionada",
  "memory.tag_placeholder": "Digite uma tag e pressione Enter",
  "memory.add_tag": "Adicionar tag",
  "memory.inspect_turn": "Auditar memórias do turno {turn}",
  "memory.save_failed": "Não foi possível salvar a memória. Tente novamente.",
  "memory.delete_failed": "Não foi possível invalidar a memória. Tente novamente.",
  ...
  "dialog.copy_failed": "Falha ao copiar",
  ...
  "prompt_composer.independent_notice": "A composição livre está ativa. Gerencie a estrutura e a ordem na categoria independente Compositor Prompt livre.",
  ...
  "prompt_composer.scene_profiles": "Perfis de cena da sessão",
  "prompt_composer.scene_session_scope": "Somente a sessão atual",
  "prompt_composer.scene_requires_session": "Abra uma sessão primeiro",
  "prompt_composer.scene_base": "Composição base",
  "prompt_composer.scene_create": "Salvar cena",
  "prompt_composer.scene_name_prompt": "Nomeie este perfil. Ele salvará o estado atual dos blocos Prompt.",
  "prompt_composer.scene_overwrite": "Sobrescrever com o atual",
  "prompt_composer.scene_delete": "Excluir cena",
  "prompt_composer.scene_delete_confirm": "Excluir o perfil de cena “{name}”?",
  "prompt_composer.scene_save_failed": "Não foi possível salvar o perfil nesta sessão. Tente novamente.",
  ...
  "prompt_composer.group_placement": "Agrupar por posição",
  "prompt_composer.sort_order": "Ordem da composição",
  "prompt_composer.sort_tokens": "Custo de Token",
  "prompt_composer.list_stats": "Exibindo {visible}/{total} · cerca de {tokens} Token",
  "prompt_composer.selected_count": "{count} selecionados",
  "prompt_composer.select_visible": "Selecionar visíveis",
  "prompt_composer.clear_selection": "Limpar seleção",
  "prompt_composer.batch_enable": "Ativar selecionados",
  "prompt_composer.batch_disable": "Desativar selecionados",
  "prompt_composer.batch_delete": "Excluir selecionados",
  "prompt_composer.batch_delete_confirm": "Excluir os {count} blocos Prompt selecionados? As entradas correspondentes da lista de prompts também serão excluídas.",
  "prompt_composer.list_empty": "Nenhum Prompt corresponde à busca.",
  "prompt_composer.select_block": "Selecionar bloco: {name}",
  "prompt_composer.unselect_block": "Desmarcar bloco: {name}",
  ...
  "prompt_composer.group_label_history": "Histórico",
  "prompt_composer.group_label_template": "Modelo",
  "prompt_composer.group_label_ordered": "Ordenado",
  "prompt_composer.group_label_in_chat": "Injeção no histórico",
  ...
  "prompt_composer.confirm_delete": "Excluir este bloco Prompt? A entrada correspondente da lista de prompts também será excluída.",
  ...
  "prompt_composer.undo": "Desfazer",
  "prompt_composer.redo": "Refazer",
  "prompt_composer.import_json": "Importar JSON",
  "prompt_composer.export_json": "Exportar JSON",
  "prompt_composer.copy_json": "Copiar JSON",
  "prompt_composer.share_json": "Compartilhar JSON",
  "prompt_composer.import_json_file": "Escolher arquivo JSON de composição Prompt",
  "prompt_composer.export_saved": "Modelo salvo em {path}",
  "prompt_composer.export_downloaded": "Arquivo de modelo {file} criado",
  "prompt_composer.export_failed": "Falha ao exportar o modelo.",
  "prompt_composer.copy_success": "JSON do modelo copiado.",
  "prompt_composer.copy_failed": "Não foi possível acessar a área de transferência.",
  "prompt_composer.share_opened": "Painel de compartilhamento aberto.",
  "prompt_composer.share_failed": "Não foi possível compartilhar: conteúdo grande demais ou incompatível. Exporte o arquivo JSON.",
  "prompt_composer.import_success": "“{name}” importado. Você pode desfazer a alteração.",
  "prompt_composer.import_failed": "Falha na importação: formato, versão ou conteúdo inválido.",
  ...
  "prompt_composer.advanced_toggle": "Avançado",
  "prompt_composer.advanced_tools_title": "Modelos e ferramentas avançadas",
  "prompt_composer.st_compat_badge": "Compatibilidade ST: {count}",
  "prompt_composer.tutorial_core_title": "Mecanismos principais e guia de uso",
  "prompt_composer.tutorial_macros_title": "Tags dinâmicas (macros) comuns",
  "prompt_composer.macro_char_desc": "Nome do personagem atual",
  "prompt_composer.macro_user_desc": "Nome / apelido do usuário atual",
  "prompt_composer.macro_description_desc": "Descrição detalhada do cartão do personagem",
  "prompt_composer.macro_personality_desc": "Traços de personalidade do personagem",
  ...
  "memory_drawer.title": "Dados da conversa",
  ...
  "lore_editor.label_secondary_keys": "Palavras-chave Secundárias (Secondary Keys)",
  "lore_editor.placeholder_secondary_keys": "Opcional, separadas por vírgulas",
  "lore_editor.label_selective_logic": "Lógica de Correspondência Secundária",
  "lore_editor.logic_and_any": "Principal e ao menos uma secundária (AND ANY)",
  "lore_editor.logic_and_all": "Principal e todas as secundárias (AND ALL)",
  "lore_editor.logic_not_any": "Principal e nenhuma secundária (NOT ANY)",
  "lore_editor.logic_not_all": "Principal e não todas as secundárias (NOT ALL)",
  "lore_editor.label_sticky": "Rodadas Persistentes (Sticky)",
  "lore_editor.label_cooldown": "Rodadas de Espera (Cooldown)",
  "lore_editor.label_delay": "Rodadas de Atraso (Delay)",
  "lore_editor.checkbox_exclude_recursion": "Excluir da recursão",
  "lore_editor.checkbox_prevent_recursion": "Impedir recursão a partir do conteúdo",
  "lore_editor.timed_recursion_title": "Efeitos Temporais e Recursão (Avançado)",
  ...
  "prompt_composer.template_group_scenes": "Predefinições de cena",
  "prompt_composer.scene_lightweight_chat": "Conversa leve",
  "prompt_composer.scene_lightweight_chat_description": "Mantém os dados essenciais do personagem e as mensagens recentes com pouco contexto.",
  "prompt_composer.scene_long_chat_budget": "Conversa longa com menos Token",
  "prompt_composer.scene_long_chat_budget_description": "Prioriza o histórico recente e remove blocos conforme a prioridade explícita.",
  "prompt_composer.scene_worldbook_priority": "Prioridade ao livro do mundo",
  "prompt_composer.scene_worldbook_priority_description": "Mantém dados ativados do livro do mundo antes e depois da definição do personagem.",
  "prompt_composer.scene_memory_enhanced": "Memória de longo prazo aprimorada",
  "prompt_composer.scene_memory_enhanced_description": "Separa resumos, memórias recuperadas e memória em tabelas para ordenar e reduzir.",
  "prompt_composer.scene_character_card_compatible": "Compatibilidade com cartão de personagem",
  "prompt_composer.scene_character_card_compatible_description": "Organiza dados do personagem, diálogos de exemplo, histórico e Prompt posterior.",
  ...
  "settings_hub.host_title": "Host e interconexão",
  "settings_hub.host_desc": "Ofereça recursos a partir deste dispositivo ou conecte-se a um host na sua rede local",
  "host_binding.host_role_title": "Este dispositivo como host",
  "host_binding.host_role_desc": "Execute o processo de host headless neste dispositivo para que outros dispositivos na mesma rede possam se conectar e chamá-lo.",
  "host_binding.bind_host": "Endereço de escuta",
  "host_binding.bind_host_hint": "127.0.0.1 só é acessível deste dispositivo. Para a rede local, use o endereço LAN deste dispositivo ou 0.0.0.0.",
  "host_binding.bind_host_loopback": "Somente local",
  "host_binding.bind_host_all": "Exposto",
  "host_binding.bind_port": "Porta de escuta",
  "host_binding.port_invalid": "A porta deve ser um inteiro entre 1 e 65535",
  "host_binding.access_key": "Chave de acesso",
  "host_binding.access_key_hint": "Obrigatória ao escutar além do localhost. Sem ela o processo de host se recusa a iniciar.",
  "host_binding.access_key_generate": "Gerar",
  "host_binding.access_key_copy": "Copiar chave",
  "host_binding.access_key_copied": "Chave de acesso copiada para a área de transferência",
  "host_binding.access_key_unsupported": "Este ambiente não tem fonte aleatória segura. Informe manualmente uma sequência longa e aleatória.",
  "host_binding.cors_origins": "Lista de permissões CORS do navegador",
  "host_binding.cors_origins_hint": "Separado por vírgulas. Vazio significa que nenhuma origem cruzada é permitida. Clientes nativos e CLI não são afetados.",
  "host_binding.cors_placeholder": "http://192.168.1.20:5173",
  "host_binding.env_title": "Configuração de inicialização",
  "host_binding.env_desc": "Escreva estas linhas no .env da raiz do projeto na máquina host e execute npm run headless. Variáveis de ambiente têm prioridade sobre qualquer ajuste do app.",
  "host_binding.env_copy": "Copiar configuração",
  "host_binding.env_copied": "Configuração de inicialização copiada",
  "host_binding.copy_failed": "Falha ao copiar. Selecione o texto e copie manualmente.",
  "host_binding.assessment_ok": "Esta configuração permite iniciar o processo de host",
  "host_binding.assessment_warning": "Pode iniciar, mas há riscos que você deve conhecer",
  "host_binding.assessment_error": "Esta configuração faz o processo de host se recusar a iniciar",
  "host_binding.issue_host_required": "Informe um endereço de escuta",
  "host_binding.issue_port_invalid": "A porta {detail} é inválida",
  "host_binding.issue_non_loopback_without_key": "Escutando em {detail} sem chave de acesso — o processo de host se recusará a iniciar",
  "host_binding.issue_weak_access_key": "A chave de acesso tem apenas {detail} caracteres; use Gerar",
  "host_binding.issue_all_interfaces_exposed": "0.0.0.0 também expõe adaptadores de hotspot e alcançáveis pela internet; prefira um endereço LAN específico",
  "host_binding.issue_lan_exposed_cleartext": "HTTP em texto claro na rede local — use apenas em rede confiável",
  "host_binding.issue_wildcard_cors": "Uma origem CORS curinga permitiria que qualquer página web enviasse credenciais; o hardening do servidor recusa isso",
  "host_binding.lan_confirm_title": "Confirmar exposição na rede local",
  "host_binding.lan_confirm_message": "Ao escutar em {host}, qualquer dispositivo na mesma rede poderá alcançar este host. Confirme que há uma chave de acesso e use apenas em rede confiável.",
  "host_binding.lan_blocked_title": "Esta configuração não pode iniciar o host",
  "host_binding.lan_blocked_message": "Corrija primeiro os erros acima (geralmente chave de acesso ausente ou porta inválida) e então gere a configuração.",
  "host_binding.remote_role_title": "Conectar a um host remoto",
  "host_binding.remote_role_desc": "Informe o endereço do host para verificar a conectividade.",
  "host_binding.remote_url": "Endereço do host",
  "host_binding.remote_url_placeholder": "192.168.1.10:18080",
  "host_binding.remote_access_key": "Chave de acesso do host",
  "host_binding.remote_test": "Testar conexão",
  "host_binding.remote_testing": "Conectando",
  "host_binding.remote_ok": "Conectado · {ms} ms",
  "host_binding.remote_summary": "Personagens {characters} · Sessões {sessions} · Modo {mode}",
  "host_binding.remote_fail_invalid_url": "Formato de endereço não reconhecido. Informe um hostname ou IP, opcionalmente com porta.",
  "host_binding.remote_fail_unauthorized": "O host recusou a chave de acesso. Verifique se corresponde à do host.",
  "host_binding.remote_fail_unreachable": "Não foi possível alcançar esse endereço. Confirme que o host está ativo, a porta aberta e os dois dispositivos na mesma rede.",
  "host_binding.remote_fail_not_a_host": "Algo respondeu ali, mas não é um host do Mobile Tavern.",
  "host_binding.stage0_notice": "Por enquanto apenas verificação de conectividade: sincronização de dados e sessões remotas ainda não estão disponíveis, então o modo remoto não serve para uso diário.",
  "host_binding.access_key_placeholder": "Não definida (obrigatória se exposto)",
  "host_sync.title": "Sincronização com host",
  "host_sync.desc": "Sincroniza dados nos dois sentidos com o host no PC. O padrão «Mesclar» usa a união dos dois lados: sessões e personagens exclusivos de qualquer um deles são mantidos e as exclusões se propagam entre dispositivos; «Sobrescrever» faz o último a escrever vencer e apaga os dados exclusivos do outro lado.",
  "host_sync.target_label": "Host remoto",
  "host_sync.not_configured": "Nenhum endereço de host definido",
  "host_sync.go_to_settings": "Configurar em «Host e rede»",
  "host_sync.mode_label": "Modo de sincronização",
  "host_sync.mode_merge": "Mesclar (recomendado)",
  "host_sync.mode_replace": "Sobrescrever",
  "host_sync.mode_merge_hint": "União dos dois lados: sessões, personagens e memórias exclusivos de qualquer um deles são mantidos, e as exclusões feitas no outro dispositivo chegam aqui. Use isto para a sincronização do dia a dia.",
  "host_sync.mode_replace_hint": "O último a escrever vence: os dados exclusivos do outro dispositivo são substituídos por completo pelo conteúdo deste. Use apenas quando quiser um dispositivo como referência.",
  "host_sync.push_btn": "Enviar para o host",
  "host_sync.pull_btn": "Baixar do host",
  "host_sync.pushing": "Enviando...",
  "host_sync.pulling": "Baixando...",
  "host_sync.merge_warning": "Um snapshot de segurança é salvo antes de sincronizar. As configurações locais (incluindo chaves de API) ficam no próprio dispositivo e não são transferidas.",
  "host_sync.overwrite_warning": "Sobrescrever apaga os dados exclusivos do outro dispositivo, por isso cada execução pede confirmação e salva antes um snapshot de segurança.",
  "host_sync.advanced_label": "Avançado",
