 ...
 * 接口方法详见 IDatabaseService。
 */
export const DatabaseServiceSchema = KernelServiceBaseSchema.extend({
  getAllSessions: fnSchema,
  getSessionById: fnSchema,
  getLatestSessionByCharacter: fnSchema,
  getSessionMessageWindow: fnSchema,
  getSessionPromptMessages: fnSchema,
  ...
  updateSessionMetadata: fnSchema,
  appendSessionMessage: fnSchema,
  commitSessionTurn: fnSchema,
  deleteSessionMessage: fnSchema,
  updateSessionMessage: fnSchema,
  replaceSessionBranch: fnSchema,
  deleteSession: fnSchema,
  replaceCompleteSessions: fnSchema,
