...
Object.defineProperty(window,'MobileTavernPlugin',{value:Object.freeze({version:2,ready:function(){return call('host.ready')},exit:function(){return call('host.exit')},setOrientation:function(orientation){return call('host.orientation',{orientation:orientation})},save:function(slot,data){return call('storage.save',{slot:slot,data:data})},load:function(slot){return call('storage.load',{slot:slot})},deleteSave:function(slot){return call('storage.delete',{slot:slot})},context:Object.freeze({get:function(){return call('context.get',{},10000)}}),chat:Object.freeze({injectAction:function(text){return call('chat.injectAction',{text:text},30000)},send:function(text){return call('chat.send',{text:text},30000)}}),llm:Object.freeze({chat:function(opts){return call('llm.chat',opts,300000)},chatStream:function(opts){return callStream('llm.chatStream',opts)},listPresets:function(){return call('llm.listPresets',{},10000)}})}),writable:false,configurable:false});
